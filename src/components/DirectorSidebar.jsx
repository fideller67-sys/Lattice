...
export default function DirectorSidebar() {
  ...
  const fetchSidebarData = async () => {
    try {
      // Assuming these endpoints exist or will be populated
    ...
    <div className="w-64 h-screen bg-[#111116] border-r border-white/5 flex flex-col relative">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-3 py-2 flex flex-col">
        <div className="space-y-8 flex-1">
          ...
          {/* Metric Dashboards Section */}
          <div>
            <div className="px-3 mb-2 text-[10px] font-bold text-gray-500 uppercase tracking-widest flex items-center justify-between">
              <span>Metric Dashboards</span>
            </div>
            <div className="space-y-1">
        ...
        {/* Action Links */}
        <div className="mt-6 space-y-1 pb-2">
          <NavLink
            to="/director/admin"
      ...
      <div className="p-4 border-t border-white/5 relative">
        ...
        >
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="text-xs text-gray-500 capitalize truncate">{user?.role || 'Engineering'}</div>
          </div>
