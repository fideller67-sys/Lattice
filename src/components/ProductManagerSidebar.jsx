...
import { LayoutDashboard, Inbox, CheckSquare, Hash, MoreVertical, UserPlus, LogOut, MessageSquare, Plus, X } from 'lucide-react';
...
export default function ProductManagerSidebar() {
  ...
  const handleCreateChannel = async (e) => {
    ...
    try {
      ...
      setNewItemName('');
      navigate(`/pm/channel/${newChannel.name}`);
    } catch (err) {
      console.error(err);
    }
  };
        ...
        <div className="space-y-8 flex-1">
          ...
          <div>
            ...
            <div className="space-y-1">
              <NavLink to="/pm/dashboard" className={navLinkClasses}>
                <div className="flex items-center gap-3">
                  <LayoutDashboard className="w-4 h-4" />
                  Dashboard
                </div>
              </NavLink>
              <NavLink to="/pm/inbox" className={navLinkClasses}>
                <div className="flex items-center gap-3">
              ...
              <NavLink to="/pm/tasks" className={navLinkClasses}>
                <div className="flex items-center gap-3">
                  <CheckSquare className="w-4 h-4" />
                  My Tasks
                </div>
              </NavLink>
              <NavLink to="/pm/channel/sprint-14-board" className={navLinkClasses}>
                <div className="flex items-center gap-3">
                  <LayoutDashboard className="w-4 h-4" />
                  Sprint Board
                </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              {channels.map((channel) => (
                <NavLink key={channel._id} to={`/pm/channel/${channel.name}`} className={channelLinkClasses}>
          ...
          <div>
            ...
            <div className="space-y-1">
              {projects.map((project) => (
                <NavLink key={project._id || project.slug} to={`/pm/project/${project.slug}`} className={channelLinkClasses}>
      ...
      <div className="p-3">
        ...
        >
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="text-[11px] font-medium text-indigo-300 uppercase tracking-wider truncate">{user?.role || 'Product'}</div>
          </div>
